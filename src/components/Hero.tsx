...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="h-screen min-h-[620px] flex items-center justify-center relative overflow-hidden"
    >
      ...
      <div
        className={`relative z-10 flex flex-col items-center justify-center w-full px-4 sm:px-8 transition-all duration-1000 ${
          isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        {/* Accroche principale */}
        <h1
          className="glass-hero max-w-4xl mx-auto text-center text-[2.2rem] md:text-6xl lg:text-7xl font-bold leading-tight mb-8 tracking-tight animate-fade-in focus:outline-none focus-visible:ring-2"
          tabIndex={-1}
        >
        ...
        {/* Sous-texte */}
        <div
          className="glass-panel-hero max-w-2xl w-full mx-auto mb-8 px-6 py-4 md:text-2xl text-lg text-center font-semibold text-[#191c22] shadow-xl animate-fade-in animate-delay-200"
        >
        ...
        <a
          href="#services"
          className="mt-2 glass-btn font-bold px-8 py-4 text-base md:text-lg rounded-full inline-flex items-center gap-2 hover:scale-[1.045] transition-transform duration-300 hover:shadow-[0_2px_30px_rgba(30,144,255,0.32)] focus:outline-none focus-visible:ring-2 animate-fade-in animate-delay-400"
        >
          ...
          <svg
            ...
            style={{ filter: "drop-shadow(0 2px 8px #5fbcf580)" }}
          >

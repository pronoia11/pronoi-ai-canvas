...
const Hero = () => {
  ...
  return <section id="home" className="h-screen min-h-[620px] flex items-center justify-center relative overflow-hidden">
      ...
      delay: 0.2
        ...
        duration: 1,
        ease: "easeOut"
      }} className="modern-title max-w-4xl mx-auto text-center text-[2.6rem] md:text-7xl lg:text-8xl font-bold leading-tight mb-10 tracking-tight focus:outline-none focus-visible:ring-2" tabIndex={-1}>
          <span className="hero-text-gradient block">
            L<span className="text-blue-600">'IA </span>
            <span className="font-normal text-slate-700 md:text-7xl text-6xl">au service de votre
              <br />imagination
            </span>
          </span>
        </motion.h1>
        ...
        scale: 0.95
          ...
          <ChevronDown className="w-5 h-5 text-blue-500 drop-shadow-lg" style={{
